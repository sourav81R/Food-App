    ...
    return (
        <div className='min-h-screen w-full flex items-center justify-center p-4 sm:p-6' style={{ backgroundColor: bgColor }}>
            <div className={`bg-white rounded-xl shadow-lg w-full max-w-md p-6 sm:p-8 border-[1px] `} style={{
                ...
                <h1 className={`text-2xl sm:text-3xl font-bold mb-2 italic`} style={{ color: primaryColor }}>PetPooja</h1>
                <p className='text-gray-600 mb-6 sm:mb-8 text-sm sm:text-base'>Create your account to get started with delicious food deliveries
                </p>

                {/* fullName */}
                <div className='mb-4'>
                    <label htmlFor="fullName" className='block text-gray-700 font-medium mb-1 text-sm sm:text-base'>Full Name</label>
                    <input
                        type="text"
                ...
                {/* mobile */}
                <div className='mb-4'>
                    <label htmlFor="mobile" className='block text-gray-700 font-medium mb-1 text-sm sm:text-base'>Mobile</label>
                    <input
                        type="tel"
                        className='w-full border rounded-lg px-3 py-2.5 sm:py-2 focus:outline-none text-sm sm:text-base'
                ...
                {/* role */}
                <div className='mb-4'>
                    <label htmlFor="role" className='block text-gray-700 font-medium mb-1 text-sm sm:text-base'>Role</label>
